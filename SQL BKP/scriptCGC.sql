...
CREATE TABLE IF NOT EXISTS `TELEFONES` (
  ...
  `PESSOA_idPESSOA` INT NOT NULL,
  `PESSOA_INSTITUICAO_idINSTITUICAO` INT NOT NULL,
  PRIMARY KEY (`idTELEFONES`, `PESSOA_idPESSOA`, `PESSOA_INSTITUICAO_idINSTITUICAO`),
  INDEX `fk_TELEFONES_PESSOA1_idx` (`PESSOA_idPESSOA` ASC, `PESSOA_INSTITUICAO_idINSTITUICAO` ASC),
